...
class FormDirector:
    ...
    # Methods with pre-made recipes for creating complex objects
    ...
    def create_register_form(self):
        (self.builder.set_action("/register")
            ...
            .add_email_input("email", "Enter your email")
            .add_password_input("pass", "Enter your password")
            .add_password_input("confirm_pass", "Confirm your password")
            .add_submit_input("Register")
        )
        return self.builder.build()
...
login = director.create_login_form()
register = director.create_register_form()
print(login)
print(register)
